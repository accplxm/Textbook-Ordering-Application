      ...
      var author = "";
   	  ...
   	  $.get("https://www.googleapis.com/books/v1/volumes?q=" + search,function(response){
          ...
          for(i=0;i<response.items.length;i++)
          {
           ...
           img = $('<img class="aligning card z-depth-5" id="dynamic"><br><a href=' + response.items[i].volumeInfo.infoLink + '><button id="imagebutton" class="btn btn-info">Read More</button></a>');
